...
export const obtenerLlamadas = async (req, res) => {
  const [filas] = await conexion.execute('SELECT * FROM llamadas');
  res.json(filas);
};


export const generarTelefonos = async (req, res) => {
...
export const editarTelefonos = async (req, res) => {
...
export const borrarTelefonos = async (req, res) => {
